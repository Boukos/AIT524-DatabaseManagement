...
1 - 4. Write four SQL queries to join two or more tables where each query contains multiple combined single-row functions. Explain what each query is intended to do. 
...
Note: Please also include your ERD from your previous HW. Thank you.